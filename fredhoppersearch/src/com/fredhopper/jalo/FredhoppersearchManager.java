...
import com.fredhopper.constants.FredhoppersearchConstants;



/**
 * This is the extension manager of the Fredhoppersearch extension.
 */
public class FredhoppersearchManager extends GeneratedFredhoppersearchManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FredhoppersearchManager.class.getName());
	 ...
	 */
	public static FredhoppersearchManager getInstance()
	{
		return (FredhoppersearchManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FredhoppersearchConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FredhoppersearchManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FredhoppersearchManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FredhoppersearchManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FredhoppersearchManager called, current tenant: " + getTenant().getTenantID());
		}
	}
