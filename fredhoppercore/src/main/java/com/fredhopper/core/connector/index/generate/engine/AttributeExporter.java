...
{
	@Override
	protected AbstractCsvWriter<FhAttributeData> createWriter(final File parentDir, final String fileName,
			final List<String> header) throws IOException
	{
		return new AttributeCsvWriter(parentDir, fileName, header);
	}
}
