...
public class MetaAttributeExporter extends ItemExporter<FhMetaAttributeData>
{
	...
	@Override
	protected AbstractCsvWriter<FhMetaAttributeData> createWriter(final File parentDir, final String fileName,
			final List<String> header) throws IOException
	{
		return new MetaAttributeCsvWriter(parentDir, fileName, header);
	}
}
