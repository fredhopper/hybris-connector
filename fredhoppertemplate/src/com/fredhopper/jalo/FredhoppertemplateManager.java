...
import com.fredhopper.constants.FredhoppertemplateConstants;



/**
 * This is the extension manager of the Fredhoppertemplate extension.
 */
public class FredhoppertemplateManager extends GeneratedFredhoppertemplateManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FredhoppertemplateManager.class.getName());
	 ...
	 */
	public static FredhoppertemplateManager getInstance()
	{
		return (FredhoppertemplateManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FredhoppertemplateConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FredhoppertemplateManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FredhoppertemplateManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FredhoppertemplateManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FredhoppertemplateManager called, current tenant: " + getTenant().getTenantID());
		}
	}
